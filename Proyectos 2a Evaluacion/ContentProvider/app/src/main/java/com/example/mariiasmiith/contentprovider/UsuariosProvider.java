...
public class UsuariosProvider extends ContentProvider {
    //DefiniciÛn del CONTENT_URI
    private static final String uri = "content://com.example.mariiasmiith.contentprovider.UsuariosProvider/usuarios";
    ...
    //genÈrico a tabla o directo a un registro, indic·ndole el formato de ambos tipos
    //de URI, de forma que pueda diferenciarlos y devolvernos su tipo.
    static {
        uriMatcher = new UriMatcher(UriMatcher.NO_MATCH);
        uriMatcher.addURI("com.example.mariiasmiith.contentprovider.UsuariosProvider", "usuarios", USUARIOS);
        uriMatcher.addURI("com.example.mariiasmiith.contentprovider.UsuariosProvider", "usuarios/#", USUARIOS_ID);
    }
    ...
    public String getType(Uri uri) {
        ...
        switch(match) {
            case USUARIOS:
                return "vnd.android.cursor.dir/vnd.com.example.mariiasmiith.contentprovider.UsuariosProvider.usuario";
            case USUARIOS_ID:
                return "vnd.android.cursor.item/vnd.com.example.mariiasmiith.contentprovider.UsuariosProvider.usuario";
            default:
                return null;
        }
    }
